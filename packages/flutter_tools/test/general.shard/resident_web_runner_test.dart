...
''');
  ...
  testUsingContext(
    ...
    () async {
      ...
      var debuggingOptions = DebuggingOptions.enabled(BuildInfo.debug, webDevServerConfig: webDevServerConfig);
      ...
      debuggingOptions = DebuggingOptions.enabled(BuildInfo.debug, webDevServerConfig: webDevServerConfig2);
